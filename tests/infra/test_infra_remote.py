...
class RemoteCliTests(unittest.TestCase):
    def test_execute_remote_bash_uses_explicit_stdin_text(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                patch("agentplane.runtime.execution_runners.subprocess.run", return_value=completed) as run_mock,
    ...
    def test_execute_remote_bash_non_dry_run_records_operation_with_preallocated_op_id(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                ...
                patch("agentplane.runtime.execution_runners.subprocess.run", side_effect=fake_run) as run_mock,
            ):
                payload = execute_remote_bash(
                    repo_root=root,
                    target="prod0-main",
