...
class RepoSnapshotContractsTests(unittest.TestCase):
    ...
    def test_expected_compose_snapshots_and_examples_still_exist(self) -> None:
        ...
        project_lifecycle = REPO_ROOT / "agentplane/scripts/onepanel/project_lifecycle.py"
        self.assertTrue(project_lifecycle.is_file(), f"missing onepanel lifecycle helper: {project_lifecycle}")
