"""Unit tests for roadmap workbook parsing in repo status.

Tests the _workbook_status() function and its helper parsers against
synthetic workbook Markdown, not the real repo workbook file.
"""
